#!/usr/bin/env python3
"""Batch-convert SAS fixture files to .ktr + .sql pairs using the OpenAI API."""
...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "data_outputs" / "llm" / "gpt"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Output directory for .ktr and .sql files (default: data_outputs/llm/gpt)",
    )
